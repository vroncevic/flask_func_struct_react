...
'''
 ...
 Copyright
     ...
     flask_func_struct_react is free software: you can redistribute it
     and/or modify it under the terms of the GNU General Public License as
     published by the Free Software Foundation, either version 3 of the
     License, or (at your option) any later version.
     flask_func_struct_react is distributed in the hope that it will
 ...
 Info
     Main entry point of tool flask_func_struct_react.
'''
...
__license__ = 'https://bit.ly/3gFSbhr'
__version__ = '1.2.0'
